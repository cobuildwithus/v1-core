...
library BudgetTCRStackActions {
    ...
    function deployBudgetStack(
        ...
        if (budgetDeployments[itemID].active) revert IBudgetTCR.STACK_ALREADY_ACTIVE();
        ...
        itemIdByBudgetTreasury[budgetTreasury] = itemID;
        ...
        budgetDeployments[itemID] = BudgetTCRStorageV1.BudgetDeployment({
            childFlow: childFlow,
