...
interface IManagedBudgetControllerStackDeployer {
    ...
    ///      scope the per-budget allocator strategy. Goal-flow and goal-treasury-derived runtime
    ///      wiring happens later during `deployBudgetTreasury(...)`.
    ...
    /// @dev Goal-flow and other live runtime wiring belongs to this phase rather than
    ///      `prepareBudgetStack(...)`.
