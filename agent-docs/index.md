...
Last verified: 2026-03-12 (budget removal semantics clarification)
...
| `agent-docs/cobuild-protocol-architecture.md` | Detailed module/domain architecture map and interaction flows. | `src/**`, `test/**` | Protocol Maintainers | Per architecture PR | High | 2026-03-11 |
...
| `agent-docs/operations/completion-workflow.md` | Post-implementation simplify, coverage-audit, completion-audit, and Solidity size-check sequence. | `agent-docs/prompts/**`, completion policy in `AGENTS.md` | Protocol Maintainers | Per process change | High | 2026-03-12 |
