...
| `agent-docs/references/testing-ci-map.md` | Testing and CI enforcement map. | `.github/workflows/**`, `scripts/**`, `package.json` | Protocol Maintainers | Per CI/process PR | Medium | 2026-02-24 |
