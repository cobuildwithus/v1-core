...
| `agent-docs/product-specs/protocol-lifecycle-and-invariants.md` | Lifecycle and consumer-facing protocol behavior constraints. | `src/goals/**`, `src/Flow.sol`, `src/tcr/**` | Protocol Maintainers | Per behavior-change PR | High | 2026-03-05 |
...
| `ARCHITECTURE.md` | Top-level repository architecture and invariants. | `src/**`, `test/**`, workflows | Protocol Maintainers | Per architecture PR | High | 2026-03-05 |
...
| `agent-docs/cobuild-protocol-architecture.md` | Detailed module/domain architecture map and interaction flows. | `src/**`, `test/**` | Protocol Maintainers | Per architecture PR | High | 2026-03-05 |
...
| `agent-docs/RELIABILITY.md` | Reliability invariants, failure modes, and verification posture. | `src/**`, `test/**`, CI checks | Protocol Maintainers | Per reliability-affecting PR | High | 2026-03-01 |
| `agent-docs/SECURITY.md` | Security boundaries and escalation criteria. | Access control, upgrade, funds, callback boundaries | Protocol Maintainers | Per security-affecting PR | High | 2026-03-01 |
...
| `agent-docs/references/module-boundary-map.md` | Contract/module boundary map and dependency directions. | `src/**` | Protocol Maintainers | Per module-boundary PR | High | 2026-03-01 |
