...
1. Read all in-scope `.sol` files, plus `judging.md` and `report-formatting.md` from the reference directory provided in your prompt, in a single parallel batch using Codex-compatible tooling. Do not use any attack vector reference files.
