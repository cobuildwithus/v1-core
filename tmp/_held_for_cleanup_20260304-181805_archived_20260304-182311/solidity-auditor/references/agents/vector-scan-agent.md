...
1. Read your bundle file in **parallel 1000-line chunks** on your first turn. The line count is in your prompt — compute the offsets and issue all chunk reads at once using Codex-compatible shell/file reads (for example, for a 5000-line file: `sed -n '1,1000p'`, `sed -n '1001,2000p'`, `sed -n '2001,3000p'`, `sed -n '3001,4000p'`, `sed -n '4001,5000p'`). Do NOT read without explicit chunk bounds. These are your ONLY file reads — do NOT read any other file after this step.
